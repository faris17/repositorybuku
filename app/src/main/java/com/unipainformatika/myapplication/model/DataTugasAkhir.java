...
public class DataTugasAkhir implements Parcelable {
    String nim, judul, studikasus, abstrak, pembimbingsatu, pembimbingdua, tanggal, namafile;
    public DataTugasAkhir() {

    }
    public DataTugasAkhir(String nim, String judul, String studikasus, String abstrak, String pembimbingsatu, String pembimbingdua, String tanggal, String namafile) {
        this.nim = nim;
        this.judul = judul;
    ...
    protected DataTugasAkhir(Parcel in) {
    ...
    public static final Parcelable.Creator<DataTugasAkhir> CREATOR = new Parcelable.Creator<DataTugasAkhir>() {
        @Override
        public DataTugasAkhir createFromParcel(Parcel source) {
            return new DataTugasAkhir(source);
        }

        @Override
        public DataTugasAkhir[] newArray(int size) {
            return new DataTugasAkhir[size];
        }
    };
}
