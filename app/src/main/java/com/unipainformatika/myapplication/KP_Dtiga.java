...
import com.unipainformatika.myapplication.adapter.KP_dTigaAdapter;
...
public class KP_Dtiga extends AppCompatActivity {
    private DatabaseReference Database;
    private ProgressDialog Dialog;
    KP_dTigaAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Database = FirebaseDatabase.getInstance().getReference().child("buku").child("kpd3");
        ...
        Database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new KP_dTigaAdapter(getApplicationContext(),list);
